...
export default function PortfolioSection() {
  ...
  return (
    <Section id="portfolio" backgroundColor="bg-white dark:bg-neutral-800">
      <Heading name={t("Portfolios")} backgroundName="Portfolio" />
            ...
            <div key={idx}>
              <div className="flex flex-col lg:flex-row lg:space-x-12">
                ...
                <div className="flex flex-col gap-4 mt-8 lg:w-1/2 lg:mt-2">
                  ...
                  <p className="text-xl leading-7">{t(`${item.description}`)}</p>
                  <ul>
                    <DetailList title={t("Technologies")} isLink={false}>
                    ...
                    <DetailList title={t("Website")} isLink={true} href={item.link} />
                  </ul>
                </div>
              </div>
            </div>
