...
export default function HomeSection() {
  return (
    <section id="home" className="bg-black-4">
      <div className="flex flex-col min-h-screen w-100 px-3 py-8 lg:py-16">
        <div className="flex flex-col grow justify-start items-center space-y-3 lg:justify-center lg:space-y-6">
          <div>
        ...
        <div className="flex justify-center grow lg:grow-0">
